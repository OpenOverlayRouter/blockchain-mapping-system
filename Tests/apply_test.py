...
print(state.trie.root_hash.encode('HEX'))
tx = Transaction(0,0,'54450450e24286143a35686ad77a7c851ada01a0', 0, '192.152.0.0/16')
tx.sign(ks.privkey)
apply_transaction(state, tx)
print("ADDRESS_FROM")
print(state.get_balance(address).own_ips)
print("ADDRESS_TO")
print(state.get_balance('54450450e24286143a35686ad77a7c851ada01a0').own_ips)
